...
namespace Diablo2RProject
{
    public partial class TBoard : UserControl
    {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            {
                PointF pos = Unproject(e.Location);
                PointF startPos = Unproject(StartPos);

                pos.X -= startPos.X;
                pos.Y -= startPos.Y;
                //pos = Unproject(pos);
                pos.X /= Game.Map.Width * TCell.Scale.X;
                pos.Y /= Game.Map.Height * TCell.Scale.Y;
                ScrollPos = new PointF(ScrollPos.X - pos.X, ScrollPos.Y - pos.Y);
                StartPos = e.Location;
            }
        }
