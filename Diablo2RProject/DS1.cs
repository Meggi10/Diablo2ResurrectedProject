                            ...
                            case LayerStreamType.LayerWall4:
                                {
                                    ...
                                    Tiles[y][x].Walls[wallIndex].Property1 = (byte)(bits & 0x000000FF);

                                    Tiles[y][x].Walls[wallIndex].Sequence = (byte)((bits & 0x00003F00) >> 8);

                                    Tiles[y][x].Walls[wallIndex].Unknown1 = (byte)((bits & 0x000FC000) >> 14);

                                    Tiles[y][x].Walls[wallIndex].Style = (byte)((bits & 0x03F00000) >> 20);

                                    Tiles[y][x].Walls[wallIndex].Unknown2 = (byte)((bits & 0x7C000000) >> 26);

                                    Tiles[y][x].Walls[wallIndex].Hidden = (byte)((bits & 0x80000000) >> 31) > 0;
                                    break;
                                }
                            ...
                            case LayerStreamType.LayerFloor2:
                                {
                                    ...
                                    Tiles[y][x].FloorsShadow[floorIndex].property1 = (byte)(bits & 0x000000FF);

                                    Tiles[y][x].FloorsShadow[floorIndex].sequence = (byte)((bits & 0x00003F00) >> 8);

                                    Tiles[y][x].FloorsShadow[floorIndex].unknown1 = (byte)((bits & 0x000FC000) >> 14);

                                    Tiles[y][x].FloorsShadow[floorIndex].style = (byte)((bits & 0x03F00000) >> 20);

                                    Tiles[y][x].FloorsShadow[floorIndex].unknown2 = (byte)((bits & 0x7C000000) >> 26);

                                    Tiles[y][x].FloorsShadow[floorIndex].hidden = (byte)((bits & 0x80000000) >> 31) > 0;
                                    break;
                                }
